...
public class Level2Activity extends AppCompatActivity {
    ...
    private static final long GREEN_TIMER_THRESHOLD = 5000;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        qNumber = findViewById(R.id.textView5);
        qScore = findViewById(R.id.text_view_score3);
        textViewCountDown = findViewById(R.id.text_view_countdown2);
        QuestionLvl0 = findViewById(R.id._text_view_question3);
        ...
        lNext = findViewById(R.id.button_next3);
            ...
            public void onClick(View v) {
                if (!answered) {
                    if (qOption1.isChecked() || qOption2.isChecked() || qOption3.isChecked()) {
                        ...
                        Toast.makeText(Level2Activity.this, "Select an answer", Toast.LENGTH_SHORT).show();
                    }
    ...
    private  void updateCountDownText(){
        ...
        if (timeLeftInMillis <= GREEN_TIMER_THRESHOLD) {
            textViewCountDown.setTextColor(Color.RED);
        } else if (timeLeftInMillis <= COUNTDOWN_IN_MILLIS) {
